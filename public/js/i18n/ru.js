...
export default {
	...
	commands: {
		...
		weather: "отправить погоду канала через бота",
		time: "отправить местное время канала через бота",
	...
	system: {
		...
		weather_failed: "не удалось получить погоду — попробуйте ещё раз",
		time_failed: "не удалось получить время — попробуйте ещё раз",
