...
export default {
	...
	system: {
		...
		censor_media_on: "media censored — images blur until tapped",
		censor_media_off: "media uncensored — images load automatically",
		censor_text_on: "message censoring on",
		censor_text_off: "message censoring off",
		panic: "panic cleared",
