...
export default {
	...
	system: {
		...
		censor_media_on: "медиа под цензурой — изображения размыты до нажатия",
		censor_media_off: "медиа без цензуры — изображения загружаются сразу",
		censor_text_on: "цензура сообщений включена",
		censor_text_off: "цензура сообщений выключена",
