...
export default {
	...
	settings: {
		...
		geo_description:
			"позволяет браузеру решать за вас, ставить ли local: ваши координаты сверяются с каналом, куда вы пишете, поэтому там, где вы действительно находитесь, вы читаетесь как местный, а в остальных местах — как телепортированный. отменяет ручной переключатель выше. ничего не отправляется — координаты не покидают это устройство.",
		...
		flair_fx_description: "анимация за сообщениями с флейром — огонь, дождь, молния и остальное. выключение сохраняет цвет каждого, но останавливает движение, что бережёт батарею телефона.",
		pow_description:
		...
		flair_fx_label: "эффекты чата",
		client_label: "тег клиента",
		local_label: "локальный тег",
		geo_label: "службы геолокации",
	...
	actions: {
		...
		reply: "ответить",
		block: "заблокировать",
		save_media: "сохранить в галерею",
	...
	guild: {
		...
		subtitle_2: "у кого та же пара, тот в том же канале.",
		name_ph: "имя гильдии",
		...
		upload_left: "вы покинули {name} до конца загрузки - ничего не отправлено",
		deleted: "сообщение отозвано",
		history_loading: "загрузка старых сообщений...",
		history_end: "начало истории этой гильдии",
		delete_failed: "не удалось отозвать это сообщение",
	},
	...
	geotag: {
		no_relays: "ни один релей не принял · проверьте соединение",
		title: "пост с геометкой",
		pick: "выберите фото с данными о месте",
		reading: "читаем фото...",
		no_data: "в этом фото нет места или даты",
		rejected: "отклонено · нечего извлечь",
		not_image: "это не изображение",
		where: "где",
		when: "когда",
		from_photo: "зона из фото",
		from_place: "зона по месту",
		placeholder: "напишите об этом фото...",
		post: "опубликовать",
		failed: "не удалось опубликовать",
		posted: "заметка с геометкой опубликована в {geo}",
	},
	notes: {
		media_photo: "загрузить фото",
		media_geotag: "геометка",
		title: "заметки",
		draft: "[ЗДЕСЬ]",
	...
	// ваш личный локальный список сохранённого
	gallery: {
		title: "галерея",
		empty: "пока ничего не сохранено — нажмите на любое сообщение в чате, чтобы оставить его",
		remove: "удалить",
		saved: { one: "сохранено в галерею", other: "сохранено в галерею: {count}" },
		rehosting: "медиа glub.chat истекает — копирую в постоянное хранилище...",
		rehost_failed: "не удалось скопировать в постоянное хранилище — не сохранено",
		gone: "ссылка мертва",
	},
	...
	suggest: {
		unblock_all: "все",
		unblock_all_meta: { one: "разблокировать всех", other: "разблокировать всех ({count})" },
		here: "{count} здесь",
	},
	...
	commands: {
		local: "геохеши, в которых вы находитесь",
		...
		dms: "открыть личные сообщения (шифрованные)",
	},
	...
	system: {
		local_header: "вы находитесь в",
		local_needs_location: "геолокация выключена — включите её в {{settings}}",
		...
		blocked: "@{name}#{tag} заблокирован. чтобы вернуть: /unblock {name}",
		block_none: "нет заблокированных",
		blocked_header: "заблокированные",
		unblocked: "@{name}#{tag} разблокирован",
		unblocked_all: "все разблокированы",
		unblock_notblocked: "{who} не заблокирован",
		unblock_ambiguous: "заблокированных пользователей с именем {name} несколько — укажите их #tag",
		...
		location_failed: "геолокация недоступна — проверьте разрешение и попробуйте снова",
