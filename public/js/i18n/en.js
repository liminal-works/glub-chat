...
export default {
	...
	commands: {
		...
		weather: "post this channel's weather via your bot",
		time: "post this channel's local time via your bot",
	...
	system: {
		...
		not_a_location: "#{geo} isn't a map location",
		weather_failed: "couldn't fetch weather — try again",
		time_failed: "couldn't fetch time — try again",
